...
- **wspolnik-demo (2026-03-29)** — synchronizacja z **gabi_site**: **grupy rozliczeniowe** (zakładka w Naliczeniach, redirect URL), **import stanu początkowego** na Lokalach, mock `/billing-groups` + `isDemoApp()` w imporcie; wpis w `CHANGELOG.md`.
