          ...
          {step === 'upload' && (
            <>
              ...
              <p className="text-sm text-slate bg-cream/80 rounded-[var(--radius-input)] px-3 py-2 border border-cream-deep">
                ...
                <span className="font-mono">25,26</span> ??? lokale 25 i 26). Gdy Excel trzyma tak?? komórk?? jako liczb??, w tle jest to float z kropk?? ??? system i tak rozpoznaje oba lokale.
              </p>
                  ...
                  <table className="text-xs border-collapse">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="border border-cream-deep px-2 py-1 text-outline italic">??? nag??ówki</td>
                      </tr>
                      <tr>
            ...
            <>
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className={`${preview.errors > 0 ? 'bg-error-container' : 'bg-cream'} rounded-[var(--radius-card)] p-3 text-center`}>
                  ...
                  <p className="text-xs text-slate mt-0.5">B????dów</p>
                </div>
              </div>
